...
package com.pblabs.engine
{
    ...
    public class PBE
    {
        ...
        /**
         * Всегда выдаст ссылку на Stage, даже если сама игра уже на ней не лежит
         * (нужна для работы консоли даже после выгрузки модуля игры)
         */
        public static function get cachedMainStage():Stage
        {
	        return _cachedStage;
        }
        private static var _cachedStage:Stage;
