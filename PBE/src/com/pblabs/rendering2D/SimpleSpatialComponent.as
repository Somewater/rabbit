...
package com.pblabs.rendering2D
{
    ...
    public class SimpleSpatialComponent extends TickedComponent implements IMobileSpatialObject2D
    {
         ...
         */
        public var _position:Point = new Point(int.MIN_VALUE, int.MIN_VALUE);
		...
		public var _size:Point = new Point(-1, -1);// FIX 07.01.2011 by Pavel Naydenov. Создать точку и в то же время пометить ее неликвидность
        ...
        public var _objectMask:ObjectType;
		public var _spatialManager:ISpatialManager2D;
    }
}
