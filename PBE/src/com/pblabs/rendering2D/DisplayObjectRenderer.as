package com.pblabs.rendering2D
{
    ...
    public class DisplayObjectRenderer extends AnimatedComponent
    {
        ...
        public var _position:Point = new Point();
		private var _posTemp:Point = new Point();
		public var _positionOffset:Point = new Point();
        ...
        {
			_posTemp.x = _position.x;
			_posTemp.y = _position.y;
            return _posTemp;
        }
