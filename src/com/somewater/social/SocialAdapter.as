package com.somewater.social
{
	...
	public class SocialAdapter extends EventDispatcher
	{
		 ...
		 * Разрешения
		 */
		public function get PERMISSION_NOTIFICATION():Boolean { return PERMISSIONS & PERMISSION_NOTIFICATION_MASK; }// разрешены нотификации (серверные)
		public function get PERMISSION_FRIENDS():Boolean { return PERMISSIONS & PERMISSION_FRIENDS_MASK; }// разрешен запрос информации о друзьях
		public function get PERMISSION_PHOTO():Boolean { return PERMISSIONS & PERMISSION_PHOTO_MASK; }// разрешена публикация в альбом
		public function get PERMISSION_WALL_USER():Boolean { return PERMISSIONS & PERMISSION_WALL_USER_MASK; }// разрешено постить себе
		public function get PERMISSION_WALL_FRIEND():Boolean { return PERMISSIONS & PERMISSION_WALL_FRIEND_MASK; }// разрешено постить другу
		public function get PERMISSION_WALL_APPFRIEND():Boolean { return PERMISSIONS & PERMISSION_WALL_APPFRIEND_MASK; }// разрешено постить app-другу
		public function get PERMISSION_BOOKMARK():Boolean { return PERMISSIONS & PERMISSION_BOOKMARK_MASK; }// разрешено добавить в закладки
		public function get PERMISSION_STATUS():Boolean { return PERMISSIONS & PERMISSION_STATUS_MASK; }// разрешено менять статус пользователя (кототкое сообщение)
		public function get PERMISSION_NOTES():Boolean {return PERMISSIONS & PERMISSION_NOTES_MASK;}// разрешено постить заметки
		public function get PERMISSION_WALL_GET():Boolean {return PERMISSIONS & PERMISSION_WALL_GET_MASK;}// разрешено смотреть содержимое стены
