package {
	...
	public class VkRabbitLoader extends EvaRabbitLoader{
		...
		override protected function createSpecificPaths():void
		{
			...
			swfs = {
						"Game":{priority:-1,preload:true,url:static_server_path + "r0/RabbitGame.swf?cb=11"}
						,"Application":{priority:-1000, preload:true,url:static_server_path + "r0/RabbitApplication.swf?cb=11"}
						,"Lang":{priority:100, preload:true, url:static_server_path + "r0/lang_pack.swf?cb=11"}
						,"XmlPack":{preload:true, url:static_server_path + "r0/xml_pack.swf?cb=11"}
