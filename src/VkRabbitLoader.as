	...
	public class VkRabbitLoader extends EvaRabbitLoader{
		...
		override protected function createSpecificPaths():void
		{
			...
			swfs = {
						...
						,"Application":{priority:-1000, preload:true,url:static_server_path + "r3/RabbitApplication.swf?cb=1"}
						...
						,"LevelMap":{preload: true, url:static_server_path + "r3/assets/level_map.swf?cb=1"}
