	...
	public class VkRabbitLoader extends EvaRabbitLoader{
		...
		override protected function createSpecificPaths():void
		{
			...
			swfs = {
						...
						,"Application":{priority:-1000, preload:true,url:static_server_path + "r3/RabbitApplication.swf?cb=3"}
						,"Lang":{priority:100, preload:true, url:static_server_path + "r3/lang_pack.swf?cb=0"}
						...
						,"LevelMap":{preload: true, url:static_server_path + "r3/assets/level_map.swf?cb=2"}
