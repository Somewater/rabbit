	...
	public class VkRabbitLoader extends EvaRabbitLoader{
		...
		override protected function createSpecificPaths():void
		{
			...
			swfs = {
						...
						,"Application":{priority:-1000, preload:true,url:static_server_path + "r3/RabbitApplication.swf?cb=0"}
						...
						,"Interface":{preload:true, url:static_server_path + "r3/assets/interface.swf?cb=0"}
						,"LevelMap":{preload: true, url:static_server_path + "r3/assets/level_map.swf?cb=0"}
