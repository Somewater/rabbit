package {
	...
	public class MailruRabbitLoader extends SocialRabbitLoader{
		...
		override protected function createSpecificPaths():void
		{
			...
			swfs = {
						"Game":{priority:-1,preload:true,url:"http://cdn9.appsmail.ru/hosting/666052/RabbitGame.swf?cb=6"}
						,
						"Application":{priority:int.MIN_VALUE,
							preload:true,url:"http://cdn0.appsmail.ru/hosting/666052/RabbitApplication.swf?cb=6"}
						,"Interface":{preload:true, url:"http://cdn6.appsmail.ru/hosting/666052/interface.swf?cb=6"}
						...
						,"XmlPack":{preload:true, url:"http://cdn8.appsmail.ru/hosting/666052/xml_pack.swf?cb=6"}
